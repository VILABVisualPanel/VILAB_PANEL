...
static const _NavigationData_type_support_symbol_names_t _NavigationData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drive_msgs, msg, NavigationData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drive_msgs, msg, NavigationData)),
  }
};
...
{
  return &::drive_msgs::msg::rosidl_typesupport_cpp::NavigationData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drive_msgs, msg, NavigationData)() {
  return get_message_type_support_handle<drive_msgs::msg::NavigationData>();
}
