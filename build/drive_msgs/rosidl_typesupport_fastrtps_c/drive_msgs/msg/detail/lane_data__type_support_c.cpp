...
#include "drive_msgs/msg/detail/lane_data__rosidl_typesupport_fastrtps_c.h"
...
#include "drive_msgs/msg/detail/lane_let__functions.h"  // currentlane, neighborlane
...
using _LaneData__ros_msg_type = drive_msgs__msg__LaneData;
  ...
  // Field name: currentlane
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, drive_msgs, msg, LaneLet
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->currentlane, cdr))
    {
      return false;
    }
  }

  // Field name: neighborlane
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _LaneData__ros_msg_type * ros_message = static_cast<_LaneData__ros_msg_type *>(untyped_ros_message);
  // Field name: currentlane
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_drive_msgs__msg__LaneData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneData__ros_msg_type * ros_message = static_cast<const _LaneData__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_drive_msgs__msg__LaneLet(
...
static uint32_t _LaneData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drive_msgs__msg__LaneData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drive_msgs
size_t max_serialized_size_drive_msgs__msg__LaneData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: currentlane
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_drive_msgs__msg__LaneLet(
  ...
  if (is_plain) {
    ...
    using DataType = drive_msgs__msg__LaneData;
    is_plain =
      (
...
static size_t _LaneData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drive_msgs__msg__LaneData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drive_msgs, msg, LaneData)() {
