...
#include "drive_msgs/msg/detail/can_output__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // acc_alive_cnt, acc_control_board_status, acc_control_status, acc_en_status, acc_err, acc_user_can_err, acc_veh_err, brk_cylinder, eps_alive_cnt, eps_control_board_status, eps_control_status, eps_en_status, eps_err, eps_sas_err, eps_user_can_err, eps_veh_can_err, g_sel_disp, hazard_en, lat_accel, long_accel1, long_accel2, override_ignore_status, override_status, str_drv_tq, str_out_tq, strang, turn_left_en, turn_right_en, vs, wheel_spd_fl, wheel_spd_fr, wheel_spd_rl, wheel_spd_rr, yaw_rate
...
using _CANOutput__ros_msg_type = drive_msgs__msg__CANOutput;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CANOutput__ros_msg_type * ros_message = static_cast<const _CANOutput__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: eps_control_board_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->eps_control_board_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: eps_control_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->eps_control_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: eps_user_can_err
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->eps_user_can_err, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: eps_veh_can_err
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->eps_veh_can_err, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: override_ignore_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->override_ignore_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: override_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->override_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: acc_control_board_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acc_control_board_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: acc_control_status
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acc_control_status, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: acc_user_can_err
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acc_user_can_err, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: brk_cylinder
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->brk_cylinder, cdr))
    {
      return false;
    }
  }

  // Field name: long_accel2
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _CANOutput__ros_msg_type * ros_message = static_cast<_CANOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: eps_en_status
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CANOutput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drive_msgs__msg__CANOutput(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drive_msgs__msg__CANOutput;
    is_plain =
      (
...
static size_t _CANOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drive_msgs__msg__CANOutput(
...
static message_type_support_callbacks_t __callbacks_CANOutput = {
  "drive_msgs::msg",
  "CANOutput",
