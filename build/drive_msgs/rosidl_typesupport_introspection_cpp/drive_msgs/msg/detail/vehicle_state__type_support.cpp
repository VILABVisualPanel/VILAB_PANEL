...
{
  new (message_memory) drive_msgs::msg::VehicleState(_init);
}

void VehicleState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drive_msgs::msg::VehicleState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleState_message_member_array[7] = {
  {
    ...
    offsetof(drive_msgs::msg::VehicleState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, mode),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, gear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, signal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, heading),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::VehicleState, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleState_message_members = {
  ...
  7,  // number of fields
  sizeof(drive_msgs::msg::VehicleState),
...
get_message_type_support_handle<drive_msgs::msg::VehicleState>()
{
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drive_msgs, msg, VehicleState)() {
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleState_message_type_support_handle;
}
