...
{
  new (message_memory) drive_msgs::msg::Actuator(_init);
}

void Actuator_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drive_msgs::msg::Actuator *>(message_memory);
  typed_message->~Actuator();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Actuator_message_member_array[3] = {
  {
    "steer",  // name
    ...
    offsetof(drive_msgs::msg::Actuator, steer),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::Actuator, accel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::Actuator, brake),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Actuator_message_members = {
  ...
  3,  // number of fields
  sizeof(drive_msgs::msg::Actuator),
...
{
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::Actuator_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drive_msgs, msg, Actuator)() {
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::Actuator_message_type_support_handle;
}
