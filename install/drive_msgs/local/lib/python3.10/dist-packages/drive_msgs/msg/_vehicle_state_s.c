...
bool drive_msgs__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drive_msgs.msg._vehicle_state.VehicleState", full_classname_dest, 42) == 0);
  }
  drive_msgs__msg__VehicleState * ros_message = _ros_message;
  {  // header
  ...
  {  // mode
    ...
    if (!std_msgs__msg__int8__convert_from_py(field, &ros_message->mode)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // gear
    ...
    if (!std_msgs__msg__string__convert_from_py(field, &ros_message->gear)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // signal
    ...
    if (!std_msgs__msg__int8__convert_from_py(field, &ros_message->signal)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * drive_msgs__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drive_msgs.msg._vehicle_state");
  ...
  {  // mode
    PyObject * field = NULL;
    field = std_msgs__msg__int8__convert_to_py(&ros_message->mode);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // gear
    PyObject * field = NULL;
    field = std_msgs__msg__string__convert_to_py(&ros_message->gear);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // signal
    PyObject * field = NULL;
    field = std_msgs__msg__int8__convert_to_py(&ros_message->signal);
    if (!field) {
      return NULL;
    }
    {
